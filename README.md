...
(`doc/nb_transformer.rst`). Sphinx allows you to automatically document your modules
and classes by using the `autodoc` directive (see `nb_transformer.rst`). To change the
